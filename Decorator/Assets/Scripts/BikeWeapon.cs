...
{
    //PART 1
    //This is the initialization code where we are setting
    //  the weapon's configuration at the Start().
    ...
    //PART 2
    //Mostly just GUI labels that will help us with debugging
    private void OnGUI()
    {
    ...
    //PART 3
    //The Reset() method resets the weapon to its initial configs by 
    //  initializing a new Weapon with its default weapon configs.
    //In Decorate() method the Decorator pattern mechanism is 
    //  triggered. 
